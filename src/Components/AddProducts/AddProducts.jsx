...
const AddProducts = () => {
    ...
    return (
        <div className='addBgz dark:bg-gray-950 text-left'>
            <div class="p-8 w-[90%] mx-auto">
                <h1 class="font-medium text-4xl text-center text-[#111230] dark:text-white">Add Your Desired Product</h1>
                <p class="text-[#111230] mt-6 text-center dark:text-white">Please Input details of the product to add it in the product details page</p>

                <form onSubmit={handleAdd}>
                    <div class="mt-8 space-y-6">
                        <div>
                            <label for="name" class="text-sm text-[#111230] block mb-1 font-medium dark:text-white">Product Name</label>
                    ...
                    <div class="mt-8 space-y-6">
                        <div>
                            <label for="name" class="text-sm text-[#111230] block mb-1 font-medium dark:text-white">Product Image URL</label>
                    ...
                    <div class="mt-8 space-y-6">
                        <div>
                            <label for="name" class="text-sm text-[#111230] block mb-1 font-medium dark:text-white">Product Price</label>
                    ...
                    <div class="mt-8 space-y-6">
                        <div>
                            <label for="name" class="text-sm text-[#111230] block mb-1 font-medium dark:text-white">Product Type</label>
                    ...
                    <div class="mt-8 space-y-6">
                        <div>
                            <label for="name" class="text-sm text-[#111230] block mb-1 font-medium dark:text-white">Product Description</label>
                    ...
                    <div className='mt-8 space-y-2'>
                        <label for="name" class="text-sm text-[#111230] block mb-1 font-medium dark:text-white">Rating:</label>
                    ...
                    <div class="space-x-4 mt-8 flex justify-center">
                        <button type="submit" class="py-3 px-5 bg-[#111230] text-white rounded hover:bg-[#5e5f92] dark:bg-[white] dark:text-[#111230] dark:hover:bg-[#5e5f92]">Add Product</button>
                    </div>
                </form>
            </div>
        </div>
