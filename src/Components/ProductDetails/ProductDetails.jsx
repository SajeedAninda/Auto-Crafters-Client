...
const ProductDetails = () => {
    ...
    return (
        <div className='text-left'>
            <div class="detailsBg dark:bg-gray-950 py-16">
                <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex flex-col md:flex-row -mx-4">
                        <div class="md:flex-1 px-4">
                            ...
                            <div class="flex -mx-2 mb-4 mt-4">
                                <div class="w-full px-2">
                                    <button onClick={handleAddToCart} class="w-full brandNameBg dark:bg-slate-400 text-white py-3 px-4 rounded-full font-bold hover:bg-[#111230] ">Add to Cart</button>
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="md:flex-1 px-4">
                            ...
                            <h2 class="text-4xl font-bold text-[#111230] dark:text-white mt-4 mb-2">{productName}</h2>
                            <p class="text-[#111230] dark:text-white text-lg mb-4">
                            ...
                            <div class="flex mb-4">
                                <div class="mr-4">
                                    <span class="font-bold text-xl text-[#111230] dark:text-white mr-2">
                                        Segment:
                                    </span>
                                    <span class="text-[#111230] dark:text-white text-lg"><span className='capitalize'>{productName}</span> belongs to the segment of <span className='capitalize'>{productType}</span></span>
                                </div>
                            </div>
                            ...
                            <div class="flex mb-4">
                                <div class="mr-4">
                                    ...
                                    <span class="text-[#111230] dark:text-white text-lg"><span className='capitalize'>{brand}</span> has set the price of <span className='capitalize'>{productName}</span> at <span className='font-bold'>{productPrice}$</span>. The price may vary from region to region.</span>
                                </div>
                            </div>
                            <div>
                                <span class="font-bold text-xl text-[#111230] dark:text-white">Description: </span>
                                <p class="text-[#111230] dark:text-white text-lg inline mt-2">
                                    {productDescription}
                                </p>
                            </div>
                        </div>
