                ...
                <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
                    ...
                    <SwiperSlide>
                        <div className='h-fit lg:h-[80vh] flex justify-center items-center flex-col'>
                            ...
                            <h3 className='text-3xl py-12 text-center text-[#111230] dark:text-white  font-bold'>Mercedes-Benz: A Legacy of Luxury</h3>
                            <p className='w-[70%] md:w-[50%] text-[#111230] dark:text-white   text-center font-medium text-base md:text-lg'>Mercedes-Benz is the embodiment of timeless luxury and relentless innovation. It's the brand that has consistently set the standard for excellence in the automotive world. When you think of Mercedes-Benz, you think of a legacy that spans generations, delivering iconic vehicles that epitomize style and class. It's a brand that has consistently pushed the envelope in terms of technology and safety, making driving not just a journey, but an experience of pure indulgence
                            </p>
                        </div>
                    </SwiperSlide>
                    ...
                    <SwiperSlide>
                        <div className='h-fit lg:h-[80vh] flex justify-center items-center flex-col'>
                            ...
                            <h3 className='text-3xl py-12 text-center text-[#111230] dark:text-white  font-bold'>Honda: The Power of Dreams</h3>
